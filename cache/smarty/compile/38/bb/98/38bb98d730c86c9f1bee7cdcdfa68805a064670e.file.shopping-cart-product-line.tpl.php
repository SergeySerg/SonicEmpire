<?php /* Smarty version Smarty-3.1.19, created on 2017-01-11 16:05:21
         compiled from "E:\Webserver\domains\sonicempire.loc\modules\onepagecheckout\views\templates\front\shopping-cart-product-line.tpl" */ ?>
<?php /*%%SmartyHeaderCode:539658763ba157f0e1-76237971%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '38bb98d730c86c9f1bee7cdcdfa68805a064670e' => 
    array (
      0 => 'E:\\Webserver\\domains\\sonicempire.loc\\modules\\onepagecheckout\\views\\templates\\front\\shopping-cart-product-line.tpl',
      1 => 1482757512,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '539658763ba157f0e1-76237971',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58763ba18dab05_63440331',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58763ba18dab05_63440331')) {function content_58763ba18dab05_63440331($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include 'E:\\Webserver\\domains\\sonicempire.loc\\tools\\smarty\\plugins\\modifier.regex_replace.php';
...
" /></span>
                            ...
                            <ul class="updown-quantity">
                                <li class="quantity-up"> <a rel="nofollow" class="no-loader cart_quantity_up" id="cart_quantity_up_<?php echo $_smarty_tpl->tpl_vars['product']->value['id_product'];?>
_<?php echo $_smarty_tpl->tpl_vars['product']->value['id_product_attribute'];?>
_0_<?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_address_delivery']);?>
...
<?php $_tmp23=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"add&amp;id_product=".$_tmp21."&amp;ipa=".$_tmp22."&amp;id_address_delivery=".$_tmp23."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value));?>
...
"></a>
                                ...
                                <li class="quantity-down"> <a rel="nofollow" class="no-loader cart_quantity_down" id="cart_quantity_down_<?php echo $_smarty_tpl->tpl_vars['product']->value['id_product'];?>
_<?php echo $_smarty_tpl->tpl_vars['product']->value['id_product_attribute'];?>
_0_<?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_address_delivery']);?>
" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_product']);?>
...
<?php $_tmp26=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"add&amp;id_product=".$_tmp24."&amp;ipa=".$_tmp25."&amp;id_address_delivery=".$_tmp26."&amp;op=down&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value));?>
	...
	<td class="my-cart_product-remove r-cart-remove">
        <?php if (!isset($_smarty_tpl->tpl_vars['noDeleteButton']->value)||!$_smarty_tpl->tpl_vars['noDeleteButton']->value) {?>
            <?php if ((!isset($_smarty_tpl->tpl_vars['customizedDatas']->value[$_smarty_tpl->tpl_vars['productId']->value][$_smarty_tpl->tpl_vars['productAttributeId']->value])||$_smarty_tpl->tpl_vars['quantityDisplayed']->value)>0&&empty($_smarty_tpl->tpl_vars['product']->value['gift'])) {?>
                <a rel="nofollow" class="no-loader my-rmv cart_quantity_delete" id="<?php echo $_smarty_tpl->tpl_vars['product']->value['id_product'];?>
_<?php echo $_smarty_tpl->tpl_vars['product']->value['id_product_attribute'];?>
_0_<?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_address_delivery']);?>
" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_product']);?>
...
<?php $_tmp29=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&amp;id_product=".$_tmp27."&amp;ipa=".$_tmp28."&amp;id_address_delivery=".$_tmp29."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value));?>
"></a><br />
            <?php }?>
        <?php }?>
