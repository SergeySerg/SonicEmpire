<?php /* Smarty version Smarty-3.1.19, created on 2016-08-31 16:00:40
         compiled from "/usr/www/users/stalkeg/sonicempire.com.ua/themes/sonicempire/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:58537189857c6d4f849c672-52908527%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c7d2169391763173c6e62844d971cf858c379e04' => 
    array (
      0 => '/usr/www/users/stalkeg/sonicempire.com.ua/themes/sonicempire/product.tpl',
      1 => 1472568390,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '58537189857c6d4f849c672-52908527',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57c6d4f8e0a556_72575224',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57c6d4f8e0a556_72575224')) {function content_57c6d4f8e0a556_72575224($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/usr/www/users/stalkeg/sonicempire.com.ua/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_math')) include '/usr/www/users/stalkeg/sonicempire.com.ua/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_function_cycle')) include '/usr/www/users/stalkeg/sonicempire.com.ua/tools/smarty/plugins/function.cycle.php';
if (!is_callable('smarty_function_counter')) include '/usr/www/users/stalkeg/sonicempire.com.ua/tools/smarty/plugins/function.counter.php';
...
">
    <div class="item-block">
     <h1 class="item-block-manuf-name"><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->manufacturer_name, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
</h1>
     <h4 itemprop="name"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true);?>
</h4>
				...
				<?php if ($_smarty_tpl->tpl_vars['have_image']->value) {?>
					<span id="view_full_size">
						<?php if ($_smarty_tpl->tpl_vars['jqZoomEnabled']->value&&$_smarty_tpl->tpl_vars['have_image']->value&&!$_smarty_tpl->tpl_vars['content_only']->value) {?>
							<a class="no-loader jqzoom" title="<?php if (!empty($_smarty_tpl->tpl_vars['cover']->value['legend'])) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cover']->value['legend'], ENT_QUOTES, 'UTF-8', true);?>
...
<?php }?>"/>
						...
						<?php } else { ?>
							<img id="bigpic" itemprop="image" style="max-height: 498px; max-width: 381px;" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value->link_rewrite,$_smarty_tpl->tpl_vars['cover']->value['id_image'],'large_default'), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php if (!empty($_smarty_tpl->tpl_vars['cover']->value['legend'])) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cover']->value['legend'], ENT_QUOTES, 'UTF-8', true);?>
<?php } else { ?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true);?>
<?php }?>" alt="<?php if (!empty($_smarty_tpl->tpl_vars['cover']->value['legend'])) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cover']->value['legend'], ENT_QUOTES, 'UTF-8', true);?>
<?php } else { ?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true);?>
				...
				<div id="views_block" class="clearfix <?php if (isset($_smarty_tpl->tpl_vars['images']->value)&&count($_smarty_tpl->tpl_vars['images']->value)<2) {?>hidden<?php }?>">
					<?php if (isset($_smarty_tpl->tpl_vars['images']->value)&&count($_smarty_tpl->tpl_vars['images']->value)>2) {?>
						<span class="view_scroll_spacer">
							<a id="view_scroll_left" class="no-loader" title="<?php echo smartyTranslate(array('s'=>'Other views'),$_smarty_tpl);?>
" href="javascript:{}">
...
"	data-fancybox-group="other-views" class="no-loader fancybox<?php if ($_smarty_tpl->tpl_vars['image']->value['id_image']==$_smarty_tpl->tpl_vars['cover']->value['id_image']) {?> shown<?php }?>"<?php }?> title="<?php echo $_smarty_tpl->tpl_vars['imageTitle']->value;?>
">
...
"<?php }?> itemprop="image" />
					...
					<?php if (isset($_smarty_tpl->tpl_vars['images']->value)&&count($_smarty_tpl->tpl_vars['images']->value)>2) {?>
						<a id="view_scroll_right" class="no-loader" title="<?php echo smartyTranslate(array('s'=>'Other views'),$_smarty_tpl);?>
" href="javascript:{}">
...
" class="no-loader" data-id="resetImages">
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['group_attribute']->value, ENT_QUOTES, 'UTF-8', true);?>
                                             ...
                                             <?php } elseif (($_smarty_tpl->tpl_vars['group']->value['group_type']=='color')) {?>
                                                 <ul id="color_to_pick_list" class="shopping-block-colors">
...
" class="no-loader color_pick<?php if (($_smarty_tpl->tpl_vars['group']->value['default']==$_smarty_tpl->tpl_vars['id_attribute']->value)) {?> selected<?php }?>"<?php if (!$_smarty_tpl->tpl_vars['img_color_exists']->value&&isset($_smarty_tpl->tpl_vars['colors']->value[$_smarty_tpl->tpl_vars['id_attribute']->value]['value'])&&$_smarty_tpl->tpl_vars['colors']->value[$_smarty_tpl->tpl_vars['id_attribute']->value]['value']) {?> style="background:<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['colors']->value[$_smarty_tpl->tpl_vars['id_attribute']->value]['value'], ENT_QUOTES, 'UTF-8', true);?>
                             ...
                             <div class="quantity">
                                 <p id="quantity_wanted_p"<?php if ((!$_smarty_tpl->tpl_vars['allow_oosp']->value&&$_smarty_tpl->tpl_vars['product']->value->quantity<=0)||!$_smarty_tpl->tpl_vars['product']->value->available_for_order||$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?> style="display: none;"<?php }?>>
                                    <!-- <label for="quantity_wanted"><?php echo smartyTranslate(array('s'=>'Quantity'),$_smarty_tpl);?>
                                     ...
                                     <span> <input <!--type="number"--> min="1" name="qty" id="quantity_wanted"  value="<?php if (isset($_smarty_tpl->tpl_vars['quantityBackup']->value)) {?><?php echo intval($_smarty_tpl->tpl_vars['quantityBackup']->value);?>
...
<?php } else { ?>1<?php }?><?php }?>" /></span>
                             </div>
                             <ul class="updown-quantity">
                                 <li class="quantity-up"><a href="#" data-field-qty="qty" class="product_quantity_up"> </a></li>
                                 <li class="quantity-down"><a href="#" data-field-qty="qty" class="product_quantity_down"></a></li>
 ...
 <b id="minimal_quantity_label"><?php echo $_smarty_tpl->tpl_vars['product']->value->minimal_quantity;?>
                        ...
                        <!--Блок В наличии/Под заказ-->
                         <div id="availability_statut" class="in-stock"<?php if (!$_smarty_tpl->tpl_vars['PS_STOCK_MANAGEMENT']->value||($_smarty_tpl->tpl_vars['product']->value->quantity<=0&&!$_smarty_tpl->tpl_vars['product']->value->available_later&&$_smarty_tpl->tpl_vars['allow_oosp']->value)||($_smarty_tpl->tpl_vars['product']->value->quantity>0&&!$_smarty_tpl->tpl_vars['product']->value->available_now)||!$_smarty_tpl->tpl_vars['product']->value->available_for_order||$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?> style="display: none;"<?php }?>>
         ...
         <!--Характеристики товара-->
             <div class="properties">
                 <?php if (isset($_smarty_tpl->tpl_vars['features']->value)&&$_smarty_tpl->tpl_vars['features']->value) {?>
                     <!-- Data sheet -->
                         <h4><?php echo smartyTranslate(array('s'=>'Data sheet'),$_smarty_tpl);?>
</h4>
...
<?php }?>
		...
		<?php if (isset($_smarty_tpl->tpl_vars['accessories']->value)&&$_smarty_tpl->tpl_vars['accessories']->value) {?>
			<!--Accessories -->
				...
				<h1><?php echo smartyTranslate(array('s'=>'Accessories'),$_smarty_tpl);?>
</h1>
...
?>
								<?php if (($_smarty_tpl->tpl_vars['accessory']->value['allow_oosp']||$_smarty_tpl->tpl_vars['accessory']->value['quantity_all_versions']>0||$_smarty_tpl->tpl_vars['accessory']->value['quantity']>0)&&$_smarty_tpl->tpl_vars['accessory']->value['available_for_order']&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)) {?>
									...
									<li class=" product-item-assosiate item product-box ajax_block_product<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['accessories_list']['first']) {?> first_item<?php } elseif ($_smarty_tpl->getVariable('smarty')->value['foreach']['accessories_list']['last']) {?> last_item<?php } else { ?> item<?php }?> product_accessories_description">
...
">
												<img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['accessory']->value['link_rewrite'],$_smarty_tpl->tpl_vars['accessory']->value['id_image'],'home_default'), ENT_QUOTES, 'UTF-8', true);?>
...
"/>
                                        ...
                                        <h4 class="product-item-manufactory"><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['accessory']->value['manufacturer_name'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
</h4>

											<h5 itemprop="name" class="product-item-name">
												<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['accessoryLink']->value, ENT_QUOTES, 'UTF-8', true);?>
">
                                            ...
                                            <p class="product-item-description">
                                                    <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['accessory']->value['description_short']),100,'...');?>
											...
											<?php }?>
                                            <a class="product-item-more" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['accessoryLink']->value, ENT_QUOTES, 'UTF-8', true);?>
">
...
<script>
    ...
    <!--<div class="accompaying-goods">
        ...
        <div class="product-item">
            <a href="#">
                <div class="product-item-img"><img src="img/Product/product-item-1.jpg" alt=""></div>
                <h4 class="product-item-manufactory">Marshall</h4>
                <h5 class="product-item-name">M-ACCS-00096</h5>
                <p class="product-item-description">Напольная колонка Премиум класса с двумя динамиками</p>
                <span class="product-item-price">10 470 грн</span>
                <a href="#" class="product-item-more">Подробнее</a>
            </a>
        </div>-->
