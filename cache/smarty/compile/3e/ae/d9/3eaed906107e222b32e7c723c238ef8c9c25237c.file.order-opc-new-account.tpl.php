<?php /* Smarty version Smarty-3.1.19, created on 2017-01-11 16:05:21
         compiled from "E:\Webserver\domains\sonicempire.loc\modules\onepagecheckout\views\templates\front\order-opc-new-account.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1682958763ba1942251-09270817%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3eaed906107e222b32e7c723c238ef8c9c25237c' => 
    array (
      0 => 'E:\\Webserver\\domains\\sonicempire.loc\\modules\\onepagecheckout\\views\\templates\\front\\order-opc-new-account.tpl',
      1 => 1482143540,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1682958763ba1942251-09270817',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58763ba2310118_82470371',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58763ba2310118_82470371')) {function content_58763ba2310118_82470371($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include 'E:\\Webserver\\domains\\sonicempire.loc\\tools\\smarty\\plugins\\modifier.regex_replace.php';
...
<?php }?>
       ...
       <!-- <div class="address-type-header delivery"><?php echo smartyTranslate(array('s'=>'Delivery address','mod'=>'onepagecheckout'),$_smarty_tpl);?>
...
"
                                <?php if ($_smarty_tpl->tpl_vars['address']->value['id_address']==$_smarty_tpl->tpl_vars['cart']->value->id_address_delivery) {?><?php $_smarty_tpl->tpl_vars["selOk"] = new Smarty_variable("1", null, 0);?>selected="selected"<?php }?>><?php echo smarty_modifier_regex_replace($_smarty_tpl->tpl_vars['address']->value['alias'],"/^dlv\-/",'');?>
</option>
                    <?php } ?>
...
" selected="selected"> -- </option>
      ...
      <div class="address_fields">
          ...
          <p>
              ...
              <input type="text" class="text" id="firstname" name="firstname" placeholder="Введите Ваше имя"
...
<?php } else { ?><?php if ($_smarty_tpl->tpl_vars['isVirtualCart']->value&&true) {?> <?php }?><?php }?>"/><!--<sup>*</sup>--><?php if (isset($_smarty_tpl->tpl_vars['opc_config']->value['validation_checkboxes'])&&$_smarty_tpl->tpl_vars['opc_config']->value['validation_checkboxes']) {?>
              <span class="validity valid_blank"></span><?php }?><?php if (isset($_smarty_tpl->tpl_vars['opc_config']->value['sample_values'])&&$_smarty_tpl->tpl_vars['opc_config']->value['sample_values']) {?>
 ...
 <?php echo smartyTranslate(array('s'=>'Jack','mod'=>'onepagecheckout'),$_smarty_tpl);?>
          ...
          <p>
              ...
              <input type="text" class="text" name="phone_mobile" id="phone_mobile" placeholder="Введите Ваш телефон"
...
<?php }?>"/><!--<sup>*</sup>--><?php if (isset($_smarty_tpl->tpl_vars['opc_config']->value['validation_checkboxes'])&&$_smarty_tpl->tpl_vars['opc_config']->value['validation_checkboxes']) {?>
                  <span class="validity valid_blank"></span><?php }?><?php if (isset($_smarty_tpl->tpl_vars['opc_config']->value['sample_values'])&&$_smarty_tpl->tpl_vars['opc_config']->value['sample_values']) {?>
                  <span class="sample_text ex_blur">(<?php echo smartyTranslate(array('s'=>'e.g.','mod'=>'onepagecheckout'),$_smarty_tpl);?>
...
<!--<sup>*</sup>--></label>
 ...
 <a href="#"
          ...
          <p>
              ...
              <input type="text" class="text" id="lastname" name="lastname" placeholder="Введите фамилию" hidden
                     value="&nbsp"/><?php if (isset($_smarty_tpl->tpl_vars['opc_config']->value['validation_checkboxes'])&&$_smarty_tpl->tpl_vars['opc_config']->value['validation_checkboxes']) {?>
              <span class="validity valid_blank"></span><?php }?><?php if (isset($_smarty_tpl->tpl_vars['opc_config']->value['sample_values'])&&$_smarty_tpl->tpl_vars['opc_config']->value['sample_values']) {?>
                  <span class="sample_text ex_blur">(<?php echo smartyTranslate(array('s'=>'e.g.','mod'=>'onepagecheckout'),$_smarty_tpl);?>
 <?php echo smartyTranslate(array('s'=>'Thompson','mod'=>'onepagecheckout'),$_smarty_tpl);?>
          ...
          <p>
              ...
              <input type="text" class="text" name="city" id="city" placeholder="Введите город" hidden
                     value="&nbsp"/><?php if (isset($_smarty_tpl->tpl_vars['opc_config']->value['validation_checkboxes'])&&$_smarty_tpl->tpl_vars['opc_config']->value['validation_checkboxes']) {?>
              <span class="validity valid_blank"></span><?php }?><?php if (isset($_smarty_tpl->tpl_vars['opc_config']->value['sample_values'])&&$_smarty_tpl->tpl_vars['opc_config']->value['sample_values']) {?>
                  <span class="sample_text ex_blur">(<?php echo smartyTranslate(array('s'=>'e.g.','mod'=>'onepagecheckout'),$_smarty_tpl);?>
...
<?php }?>"/><?php if (isset($_smarty_tpl->tpl_vars['opc_config']->value['validation_checkboxes'])&&$_smarty_tpl->tpl_vars['opc_config']->value['validation_checkboxes']) {?>
        ...
        <p class="required text" hidden <?php if ($_smarty_tpl->tpl_vars['isVirtualCart']->value&&$_smarty_tpl->tpl_vars['opc_config']->value['virtual_no_delivery']) {?>style="display: none;"<?php }?>>
 ...
 <?php echo smartyTranslate(array('s'=>'15 High Street','mod'=>'onepagecheckout'),$_smarty_tpl);?>
          ...
          <?php if ($_smarty_tpl->tpl_vars['isVirtualCart']->value&&$_smarty_tpl->tpl_vars['opc_config']->value['virtual_no_delivery']) {?>
              <input type="hidden" name="id_country" id="id_country"
                     value="<?php if (isset($_smarty_tpl->tpl_vars['onlineCountryActive']->value)&&$_smarty_tpl->tpl_vars['opc_config']->value['online_country_id']>0) {?><?php echo $_smarty_tpl->tpl_vars['opc_config']->value['online_country_id'];?>
<?php } else { ?><?php echo $_smarty_tpl->tpl_vars['sl_country']->value;?>
<?php }?>"/>
          <?php } else { ?>
...
<?php }?>
        ...
        <?php }?>
          <span class="star_se">поля, обязательные для заполнения</span>
...
?>
                            <option value="<?php echo intval($_smarty_tpl->tpl_vars['address']->value['id_address']);?>
"
                                    <?php if ($_smarty_tpl->tpl_vars['address']->value['id_address']==$_smarty_tpl->tpl_vars['cart']->value->id_address_invoice) {?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['address']->value['alias'];?>
</option>
                        <?php } ?>
                    <?php }?>
                </select>
...
<div class="buy-block-cart" style="display:none">
...
<?php } else { ?><?php if (($_smarty_tpl->tpl_vars['def_state']->value>0)) {?><?php echo $_smarty_tpl->tpl_vars['def_state']->value;?>
...
<?php } else { ?><?php if (($_smarty_tpl->tpl_vars['def_state_invoice']->value>0)) {?><?php echo $_smarty_tpl->tpl_vars['def_state_invoice']->value;?>
<?php } else { ?>false<?php }?><?php }?>;
