<?php /* Smarty version Smarty-3.1.19, created on 2016-09-01 11:44:00
         compiled from "D:\OpenServer\domains\sonicempire.loc\themes\sonicempire\product-sort.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1939457c7ea50bed370-56689324%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cf20af2c3042ce5efd08c34162f03355797fc0ec' => 
    array (
      0 => 'D:\\OpenServer\\domains\\sonicempire.loc\\themes\\sonicempire\\product-sort.tpl',
      1 => 1472717912,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1939457c7ea50bed370-56689324',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57c7ea50e4c0d5_72234724',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57c7ea50e4c0d5_72234724')) {function content_57c7ea50e4c0d5_72234724($_smarty_tpl) {?>
...
" class="productsSortForm" style="display: none">
    <div class="sort">
		<h4 for="selectProductSort<?php if (isset($_smarty_tpl->tpl_vars['paginationId']->value)) {?>_<?php echo $_smarty_tpl->tpl_vars['paginationId']->value;?>
...
<?php }?>"<?php if (!in_array($_smarty_tpl->tpl_vars['orderby']->value,array('price','name','quantity','reference'))&&$_smarty_tpl->tpl_vars['orderby']->value==$_smarty_tpl->tpl_vars['orderbydefault']->value) {?> selected="selected"<?php }?>>--</option>
			...
			<?php }?>
            <option value="sales:asc" <?php if ($_smarty_tpl->tpl_vars['orderby']->value=='sales'&&$_smarty_tpl->tpl_vars['orderway']->value=='asc') {?>selected="selected"<?php }?>><?php echo smartyTranslate(array('s'=>'Sales: Worst to Best'),$_smarty_tpl);?>
</option>
            ...
            <option value="sales:desc" <?php if ($_smarty_tpl->tpl_vars['orderby']->value=='sales'&&$_smarty_tpl->tpl_vars['orderway']->value=='desc') {?>selected="selected"<?php }?>><?php echo smartyTranslate(array('s'=>'Sales: Best to Worst'),$_smarty_tpl);?>
</option>-->
