<?php /* Smarty version Smarty-3.1.19, created on 2017-01-11 16:05:20
         compiled from "E:\Webserver\domains\sonicempire.loc\modules\onepagecheckout\views\templates\front\shopping-cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2135158763ba0d17640-63139113%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6dc85756ca49b8e54287adff43641320c9ae43c5' => 
    array (
      0 => 'E:\\Webserver\\domains\\sonicempire.loc\\modules\\onepagecheckout\\views\\templates\\front\\shopping-cart.tpl',
      1 => 1482757512,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2135158763ba0d17640-63139113',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58763ba15042d7_73613997',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58763ba15042d7_73613997')) {function content_58763ba15042d7_73613997($_smarty_tpl) {?>
...
";
        var opc_hide_carrier = '<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['hide_carrier'];?>
';
...
<?php }?></span>
    ...
    <?php }?>
<div id="order-detail-content" class="table_block<?php if (isset($_smarty_tpl->tpl_vars['addClass']->value)) {?><?php echo $_smarty_tpl->tpl_vars['addClass']->value;?>
<?php }?>">
<table id="cart_summary" class="my-cart">
<thead>
<tr>
    <th class="my-cart_product"><?php echo smartyTranslate(array('s'=>'Product','mod'=>'onepagecheckout'),$_smarty_tpl);?>
</th>
    ...
    <th class="my-cart_product-available"><?php echo smartyTranslate(array('s'=>'In stock','mod'=>'onepagecheckout'),$_smarty_tpl);?>
</th>
    <th class="my-cart_product-quantity"><?php echo smartyTranslate(array('s'=>'Qty','mod'=>'onepagecheckout'),$_smarty_tpl);?>
</th>
    <th class="my-cart_product-total"><?php echo smartyTranslate(array('s'=>'Unit price','mod'=>'onepagecheckout'),$_smarty_tpl);?>
</th>
...
<tr>
    ...
    <td class="my-text-price"><?php echo smartyTranslate(array('s'=>'Total:','mod'=>'onepagecheckout'),$_smarty_tpl);?>
</td>
...
<div id="HOOK_SHOPPING_CART"><?php echo $_smarty_tpl->tpl_vars['HOOK_SHOPPING_CART']->value;?>
    ...
    <?php if (!$_smarty_tpl->tpl_vars['opc_config']->value['two_column_opc']&&(!$_smarty_tpl->tpl_vars['opc_config']->value['cart_summary_bottom']||($_smarty_tpl->tpl_vars['order_process_type']->value==0&&(!$_GET['step']||$_GET['step']!='1')))) {?>
            <div class="order-button-block order-button-block-top clearfix">
                ...
                <?php if (isset($_smarty_tpl->tpl_vars['onlyCartSummary']->value)) {?><a href="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order.php',true), ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
"><?php echo smartyTranslate(array('s'=>'Next','mod'=>'onepagecheckout'),$_smarty_tpl);?>
 &raquo;</a><?php }?>
                <a class="button-in-cart back-to-shopping" href="<?php if ((isset($_SERVER['HTTP_REFERER'])&&strstr($_SERVER['HTTP_REFERER'],'{$opckt_script_name}'))||!isset($_SERVER['HTTP_REFERER'])) {?><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('index.php'), ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
">
                <?php echo smartyTranslate(array('s'=>'Continue shopping','mod'=>'onepagecheckout'),$_smarty_tpl);?>
</a><?php if (!isset($_smarty_tpl->tpl_vars['onlyCartSummary']->value)) {?><a href="#" class="button-in-cart my-checkout">Оформление заказа</a><?php }?>
<script>
...
'});
        ...
        <input type="hidden" name="id_country" id="id_country"
               value="<?php if (isset($_smarty_tpl->tpl_vars['opc_config']->value['online_country_id'])&&$_smarty_tpl->tpl_vars['opc_config']->value['online_country_id']>0) {?><?php echo $_smarty_tpl->tpl_vars['opc_config']->value['online_country_id'];?>
<?php } else { ?>8<?php }?>"/> 
            <?php } else { ?>
