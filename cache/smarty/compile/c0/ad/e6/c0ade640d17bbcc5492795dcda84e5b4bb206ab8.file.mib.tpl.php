<?php /* Smarty version Smarty-3.1.19, created on 2016-08-31 15:41:01
         compiled from "/usr/www/users/stalkeg/sonicempire.com.ua/modules/mib/views/templates/hook/mib.tpl" */ ?>
<?php /*%%SmartyHeaderCode:65002265257c6d05d0358c6-47304416%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c0ade640d17bbcc5492795dcda84e5b4bb206ab8' => 
    array (
      0 => '/usr/www/users/stalkeg/sonicempire.com.ua/modules/mib/views/templates/hook/mib.tpl',
      1 => 1472586320,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '65002265257c6d05d0358c6-47304416',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57c6d05d0cd075_54788004',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57c6d05d0cd075_54788004')) {function content_57c6d05d0cd075_54788004($_smarty_tpl) {?><?php if (($_smarty_tpl->tpl_vars['page_name']->value!='index')) {?>
...
?>
                        <?php if ($_smarty_tpl->tpl_vars['manufacturer']->value['image']) {?>
                            <li class="<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['manufacturer_list']['last']) {?>last_item<?php } elseif ($_smarty_tpl->getVariable('smarty')->value['foreach']['manufacturer_list']['first']) {?>first_item<?php } else { ?>item<?php }?>">
                                <a href="#" data-tab="#manufacturer-descrition-<?php echo $_smarty_tpl->tpl_vars['manufacturer']->value['id_manufacturer'];?>
...
"/>
                            ...
                            <div class="manuf-description-dropdown">
                                ...
                                <div class="r-link-block">
                                    ...
                                    <a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getmanufacturerLink($_smarty_tpl->tpl_vars['manufacturer']->value['id_manufacturer'],$_smarty_tpl->tpl_vars['manufacturer']->value['link_rewrite']), ENT_QUOTES, 'UTF-8', true);?>
" class="products-of-manufacturer">Товары этого производителя<i class="fa fa-angle-right"></i></a>
                                </div>
                            </div>
