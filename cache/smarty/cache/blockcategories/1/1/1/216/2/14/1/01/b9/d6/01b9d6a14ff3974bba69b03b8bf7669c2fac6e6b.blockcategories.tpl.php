...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_578d3fd3801631_66540892',
  'has_nocache_code' => false,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_578d3fd3801631_66540892')) {function content_578d3fd3801631_66540892($_smarty_tpl) {?><!-- Block categories module -->
	...
	href="http://sonicempire.loc/13-akustika" <!--title="-->">
		Акустика
			...
			<ul class="sub_menu">
												<li class="last">
	<a 
	href="http://sonicempire.loc/14-napolnaya" class="selected" style="color: #bf6d3b; "  <!--title="-->">
		Напольная
	</a>
	</li>
