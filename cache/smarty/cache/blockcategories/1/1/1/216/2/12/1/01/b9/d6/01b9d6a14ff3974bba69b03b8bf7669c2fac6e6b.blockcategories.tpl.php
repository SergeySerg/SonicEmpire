...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_578d3fe06b4550_79463537',
  'has_nocache_code' => false,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_578d3fe06b4550_79463537')) {function content_578d3fe06b4550_79463537($_smarty_tpl) {?><!-- Block categories module -->
 ...
 our selection of dresses to find one that suits you.-->">
	...
	href="http://sonicempire.loc/14-napolnaya" <!--title="-->">
		Напольная
																...
																<li class="last">
	<a 
	href="http://sonicempire.loc/12-komplekty-akustiki" class="selected" style="color: #bf6d3b; "  <!--title="-->">
		Комплекты акустики
	</a>
	</li>
