    ...
    public function _setOptions()
    {
        ...
        $this->module_settings = array(
            "general"          => array(
                ...
                "above_confirmation_message" => new Option(OptionType::RadioBox,   $this->l('Message above Confirm button'), $this->l('Display message (e.g. EU regulations / taxes) just above Confirmation button. Please translate \'above confirmation button msg\' in BO / Tools / Translations / Translations of installed modules')),
                ...
                "move_message"               => new Option(OptionType::RadioBox,   $this->l('Move Order Message box'), $this->l('Moves Order Message box down from carrier section, above \'I confirm my order\' button.')),
