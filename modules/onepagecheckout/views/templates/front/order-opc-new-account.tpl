      ...
      <div class="address_fields">
          ...
          <p>
              ...
              <input type="text" class="text" id="firstname" name="firstname" placeholder="Введите Ваше имя"
                     value="{if isset($guestInformations) && isset($guestInformations.firstname) &&  $guestInformations.firstname}{$guestInformations.firstname}{else}{if $isVirtualCart && true} {/if}{/if}"/><!--<sup>*</sup>-->{if isset($opc_config.validation_checkboxes) && $opc_config.validation_checkboxes}
              <span class="validity valid_blank"></span>{/if}{if isset($opc_config.sample_values) && $opc_config.sample_values}
          ...
          <p>
              ...
              <input type="text" class="text" id="lastname" name="lastname" placeholder="Введите фамилию" hidden
                     value="&nbsp"/>{if isset($opc_config.validation_checkboxes) && $opc_config.validation_checkboxes}
              <span class="validity valid_blank"></span>{/if}{if isset($opc_config.sample_values) && $opc_config.sample_values}
        ...
        <p class="required text" hidden {if $isVirtualCart && $opc_config.virtual_no_delivery}style="display: none;"{/if}>
