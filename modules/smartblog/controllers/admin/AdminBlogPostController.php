    ...
    public function renderForm() 
     {
      $img_desc = '';
        ...
        $this->fields_form = array(
          'legend' => array(
          'title' => $this->l('Страница информации о компании'),
            ),
            'input' => array(
                array(
                    'type' => 'hidden',
                ...
                array(
                    'type' => 'text',
                    'label' => $this->l('Название страницы'),
                    'name' => 'meta_title',
                    'size' => 60,
                    'required' => true,
                    'desc' => $this->l('Введите название страницы'),
                    'lang' => true,
                ),
                array(
                    'type' => 'textarea',
                    'label' => $this->l('Содержание страницы'),
                    'name' => 'content',
                    'lang' => true,
                    'rows' => 10,
                    'cols' => 62,
                    ...
                    'autoload_rte' => true,
                    'required' => true,
                    'desc' => $this->l('Введите текст страницы')
                ),
                array(
                    'type' => 'textarea',
                    'label' => $this->l('Краткое описание'),
                    'name' => 'short_description',
                    'rows' => 10,
                    'cols' => 62,
                    'lang' => true,
                    'required' => true,
                    'desc' => $this->l('Введите краткое описание страницы')
                ),
               /* array(
                    'type' => 'file',
                ...
                array(
                    'type' => 'text',
                    'label' => $this->l('Мета ключевые слова'),
                    'name' => 'meta_keyword',
                    'lang' => true,
                    'size' => 60,
                    'required' => false,
                    'desc' => $this->l('Введите свои мета ключевые слова. Разделяйте их запятой(,)')
                ),

                array(
                    'type' => 'textarea',
                    'label' => $this->l('Мета описание'),
                    'name' => 'meta_description',
                    'rows' => 10,
                    'cols' => 62,
                    'lang' => true,
                    'required' => false,
                    'desc' => $this->l('Введите свое мета описание')
                ),/*
                array(
                    'type' => 'text',
                ...
                array(
                    ...
                    'lang' => true,
                    'required' => false,
                    'desc' => $this->l('Введите свои мета теги. Разделяйте их запятой(,)')
                ),/*
                array(
                                        'type' => 'radio',
                ...
                array(
                                        'type' => 'radio',
                                        'label' => $this->l('Отображение страницы'),
                                        'name' => 'active',
                                        'required' => false,
                                        'class' => 't',
                                        'is_bool' => true,
