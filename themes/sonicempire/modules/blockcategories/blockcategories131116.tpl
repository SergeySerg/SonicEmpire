...
<div id="categories_block_left">
	<!--<h2 class="title_block">
        ...
        <ul id="r-catalog-open" class="col-xs-12 {*{if {$page_name} == 'manufacturer' || {$page_name} == 'category' }col-sm-9 {/if}*} {if isset($categories_manufacturer_filter)}col-sm-9{/if} catalog">
